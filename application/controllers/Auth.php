...
class Auth extends CI_Controller 
{
  ...
  public function registration()
  {
    ...
    if($this->form_validation->run() == false){
      ...
      Congratulations! You have successfully registered, Please activate your account!</div>');
      redirect('auth');
    }
  ...
  private function _sendEmail($token , $type)
  {
    $config = [
      ...
      'smtp_user' => 'taufiq.alif0104@gmail.com',
      'smtp_pass' => 'tcukimay1997',
      'smtp_port' => '465',
      'mailtype'  => 'html',
      'charset'   => 'utf-8',
      'newline'   => "\r\n"
    ...
    $this->email->from('aliftaufiq4@gmail.com' , 'Admin');
